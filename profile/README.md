...
_* 3기는 국민대학교 디자인 동아리 STACK과 함께 프로젝트를 진행합니다._
...
앱 개발을 공부할 때, 직접 앱을 구현해보는 것이 최고의 방법입니다. 아이폰의 기본 앱들을 직접 만들어보면서 실제 사용하는 앱을 만드는 경험을 통해 iOS 앱 개발을 훨씬 더 흥미롭게 배울 수 있습니다!

강의를 통해 익힌 기능들을 실제 앱 개발에 적용할 수 있도록, 매 수업마다 다양한 미션을 제공합니다. 이를 통해 실제 프로젝트에서 이용할 수 있도록, 화면 구성과 전환과 같은 기초부터 데이터 활용, 서버와의 협업까지 넓은 범위를 다루고 있습니다.

iOS와 SwiftUI의 매력과 앱 개발에 대한 흥미를 느낄 수 있을 것입니다!
